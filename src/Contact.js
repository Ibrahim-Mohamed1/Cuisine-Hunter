                ...
                {this.state.toggle ?
                    <>
                        ...
                        <span style={{ fontSize: "1.5em", border: "solid white", marginRight: 50, marginTop: 20, marginLeft: 50, display: "block", borderRadius:10 }}>
                            <p className="" style={{ paddingLeft: 10, paddingRight: 10, marginTop:0,paddingTop:30, marginBottom:0, paddingBottom:30,textAlign: "center", color:"cyan" }}>Need to contact us? Please reach out to one of our professional team members to address your concern. We will have a resolution to your concern as soon as possible.</p>
                        </span>
                        <br />
                        <br />
                ...
                :
                    <>
                        ...
                        <span style={{ fontSize: "1.5em", border: "solid darkCyan", marginRight: 50, marginTop: 20, marginLeft: 50, display: "block", borderRadius:10}}>
                            <p style={{ paddingLeft: 10, paddingRight: 10, paddingTop: 30, paddingBottom: 30, textAlign: "center", marginTop:0, marginBottom:0, borderRadius:7, color:"cyan" }}>Thank you so much for your feedback! We greatly appreciate you for reaching out to us! Please allow 24 hours to hear back from one of our team members. Thank you!</p>
                        </span>
                        <br/>
                        <br/>
                        <br/>
                        <Link style={{textDecoration:"none"}} to="/"><button className="homeButton" style={{ display: "block", margin: "auto", zoom: 3.5, borderRadius: 5, border:"solid cyan" }}>Done</button></Link>
                    </>
                }
            </div>
        )
